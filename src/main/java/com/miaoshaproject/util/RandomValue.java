...
public class RandomValue {
    ...
    private static String[] registerMode = {"weixin","zhifubao","web"};
    ...
    public static UserModel getRandomUser(){
        ...
        model.setName(getChineseName());
        model.setTelephone(getTel());
        model.setAge(getNum(1,120));
        model.setGender((byte)getNum(1,2));
        model.setRegisterMode(registerMode[getNum(0,2)]);
        return model;
    }
